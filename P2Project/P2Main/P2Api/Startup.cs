    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddCors((options) =>
            {
                ...
                {
                    builder.WithOrigins("http://127.0.0.1:5500", "http://localhost:4200", "https://localhost:44307", "https://pokeloot.azurewebsites.net/", "https://pokeloot.z19.web.core.windows.net/")   // update thisssssssssss to proper ip / pathing
                    .AllowAnyHeader()
                    .AllowAnyMethod();
                });
            });
